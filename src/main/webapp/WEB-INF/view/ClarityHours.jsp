...
<body>
	...
	<br>
	<div class="panel panel-default" style="width: 101.5%;" >
		<table>
			...
			<div id="updatebtn" class="edit_statics">
				...
				TimeSheet Hours : <input ="text"  id="totalhours" class="totalhours" readonly/>
				Backlog Hours : <input ="text"  id="totalbhours" class="totalbhours" readonly/>
	...
	<div>
		...
		<table>
			<tr>
				<td><select id="selectMonth" class="edit_header" style="width:95px;"></select></td>
				<td>
